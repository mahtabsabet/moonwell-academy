...
const STUDENTS = [
  ...
  { id: "pip", name: "Pip", color: [235, 205, 90], sprite: "stu_pip",
    ...
    sched: {
      morning:   { room: "potions", gx: 3, gy: 6, dir: "up", act: "sit" },
  ...
  { id: "luna", name: "Luna", color: [180, 160, 225], sprite: "stu_luna",
    ...
    sched: {
      morning:   { room: "divination", gx: 4, gy: 6, dir: "up", act: "sit" },
  ...
  { id: "hazel", name: "Hazel", color: [205, 160, 110], sprite: "stu_hazel",
    ...
    sched: {
      morning:   { room: "crystals", gx: 4, gy: 6, dir: "up", act: "sit" },
  ...
  { id: "briar", name: "Briar", color: [80, 150, 150], sprite: "stu_briar",
    ...
    sched: {
      morning:   { room: "spellcraft", gx: 4, gy: 6, dir: "up", act: "sit" },
  ...
  { id: "cleo", name: "Cleo", color: [160, 120, 200], sprite: "stu_cleo",
    ...
    sched: {
      morning:   { room: "kitchen", gx: 4, gy: 6, dir: "up", act: "sit" },
  ...
  { id: "marlow", name: "Marlow", color: [110, 140, 210], sprite: "stu_marlow",
    ...
    sched: {
      morning:   { room: "potions", gx: 5, gy: 6, dir: "up", act: "sit" },
